...
$(document).ready(function() {
	...
	// gestione dell'apertura e della chiusura della sidebar automatica in base alle visite precedenti
	// se esiste il cookie allora faccio quello che è indicato
	if($.cookie("sidebar-collapsed") == 'true') {
		$('.sidebar-toggle').click();
	}

	// quando clicco il pulsante di toggle della sidebar salvo un cookie
	// con lo stato impostato
	$('.sidebar-toggle').on('click', function(event) {
		if(typeof($.cookie("sidebar-collapsed")) == undefined || $.cookie("sidebar-collapsed") == 'true') {
